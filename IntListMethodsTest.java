import intlistmethods.IntList;
import intlistmethods.IntListMethods;
import java.util.*;
...
public class IntListMethodsTest {
    ...
    public static void main(String[] args) {
        int seed = 1234567;//Integer.parseInt(args[0]);
        int rounds = 10;//Integer.parseInt(args[1]);
        int size = 100;//Integer.parseInt(args[2]);  
        int total;
        try {
            total = test(seed, rounds, size, true);//args.length > 3 && args[3].toLowerCase().startsWith("t"));
        }
